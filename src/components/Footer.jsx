  ...
  <div className="w-full max-w-[1200px] mx-auto flex flex-col md:flex-row gap-10 border-b border-gray-700 pb-8 px-4">
    ...
    <div className="w-full md:w-[45%] text-center md:text-left">
      ...
      <p className="text-[16px] text-[#ffffffa4] leading-relaxed">
        " <strong>BidNext</strong> ilə hər növ əşyaların satışı artıq daha asan və şəffafdır. İndi qoşul və rəqəmsal hərracın bir parçası ol!"
      </p>
    </div>
    ...
    <div className="w-full md:w-[55%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="text-center md:text-left">
        <h3 className="text-2xl text-[#00df9a] font-bold select-none mb-2">Şirkət</h3>
      ...
      {/* Bölmə 3: Dəstək */}
      <div className="text-center md:text-left">
        <h3 className="text-2xl text-[#00df9a] font-bold select-none mb-2">Dəstək</h3>
        <ul className="space-y-2 text-[16px] text-[#ffffffa4]">
          <li className="hover:text-[#00df9a] cursor-pointer">Tez-tez verilən suallar</li>
          <li className="hover:text-[#00df9a] cursor-pointer">Məxfilik siyasəti</li>
          <li className="hover:text-[#00df9a] cursor-pointer">Əlaqə</li>
        </ul>
      </div>

      {/* Bölmə 4: Qaydalar */}
      <div className="text-center md:text-left">
        <h3 className="text-2xl text-[#00df9a] font-bold select-none mb-2">Qaydalar</h3>
        <ul className="space-y-2 text-[16px] text-[#ffffffa4]">
          <li className="hover:text-[#00df9a] cursor-pointer">İstifadəçi şərtləri</li>
          <li className="hover:text-[#00df9a] cursor-pointer">Qanunvericilik</li>
        </ul>
      </div>
