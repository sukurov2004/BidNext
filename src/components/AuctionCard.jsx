...
function AuctionCard({ title, image, price, timeLeft }) {
  return (
   <div className="bg-[#0A0F1A] rounded-2xl shadow-lg p-4 w-full max-w-sm border border-gray-200">
  ...
  <button className="mt-4 bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition duration-200">
   Təklif ver
  </button>
